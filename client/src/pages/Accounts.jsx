      ...
      <div className="flex flex-col gap-1.5">
        ...
        {filtered.map(a => (
          <Link
            key={a.id}
            to={`/accounts/${a.id}`}
            className="flex items-center gap-3 px-4 py-3 bg-card border border-border rounded hover:border-accent-blue/40 hover:bg-[#11161e] transition"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[13px] font-medium text-text-primary truncate">{a.account_name}</div>
